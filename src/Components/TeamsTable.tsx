            ...
            <div className=' rounded-lg border border-neutral-800 bg-light-black text-gray-300'>
                <table className='mx-auto w-full '>
                    <thead className='border-b border-neutral-800'>
                        <tr >
                            <th className='py-4 pl-8 text-left font-semibold'>Name</th>
                    ...
                    <tbody>
                        {teams.map((team, index) => (
                            <tr key={team.id}
                                ...
                                <td className={`px-4 py-4 text-gray-400 text-left ${team.status === 'Active' ? 'text-emerald-400' : 'text-red-500'}`}>{team.status}</td>
                                <td className="px-4 py-4 text-gray-400 text-left ">
